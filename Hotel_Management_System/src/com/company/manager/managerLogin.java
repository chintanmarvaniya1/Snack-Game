...
public class managerLogin {
    ...
    public static JButton login,cancel, ragister;
    public static establishConnection dc = new establishConnection();
    public static JLabel managerImg;


    public managerLogin(){
        widgetDesign design = new widgetDesign();
        homeFrame =design.createFrame("MANAGER|LOGIN",75, 20, 1500, 800);
        ...
        managerImg=design.setImageAsBackground("images/managerLogo.png",690,220,150,150);
        homeFrame.add(managerImg);
        ...
        ragister =design.createButton("New Manager",650,652,200,40,20);
        ragister.addActionListener(new Action_performed());
        homeFrame.add(ragister);
    ...
    private static class Action_performed implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource()==login){
                try{
                    String q="select * from employee_detail where designation='Manager' and emp_id='"+userField.getText()+"' and pass ='"+passField.getText()+"'";
