...
public class receptionistLogin {
    ...
    public receptionistLogin(){
        ...
        homeFrame =design.createFrame("RECEPTIONIST|LOGIN",75, 20, 1500, 800);
        ...
        receptionistImg =design.setImageAsBackground("images/receptionistLogo.png",690,220,150,150);
    ...
    private static class Action_performed implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if (e.getSource()==login){
                try{
                    String q="select * from employee_detail where designation='Receptionist' and emp_id='"+userField.getText()+"' and pass ='"+passField.getText()+"'";
